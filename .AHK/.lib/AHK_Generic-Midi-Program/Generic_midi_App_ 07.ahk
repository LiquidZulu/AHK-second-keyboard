...
;*************************************************
#Include %A_LineFile%\..\MidiRules.ahk              ; this file contains: Rules for manipulating midi input then sending modified midi output.
#Include %A_LineFile%\..\hotkeyTOmidi_1.ahk         ; this file contains: examples of HOTKEY generated midi messages to be output - the easy way!
#Include %A_LineFile%\..\hotkeyTOmidi_2.ahk         ; this file contains: examples of HOTKEY generated midi messages to be output - the BEST way!
;#include joystuff.ahk              ; this file contains: joystick stuff.   
;#include xy_mouse.ahk
#Include %A_LineFile%\..\mio2.ahk       ; this file replaced the midi in out lib below - for now