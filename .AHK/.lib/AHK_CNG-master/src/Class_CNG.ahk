...
class Crypt
{
	...
	*/
	...
	class Verify
	{
		...
		ChainingMode(ChainMode){ ; switch wasnt working
			if (ChainMode == "CBC"){
				return Crypt.Constants.BCRYPT_CHAIN_MODE_CBC
			}
			if (ChainMode == "ChainingModeCBC"){
				return Crypt.Constants.BCRYPT_CHAIN_MODE_CBC
			}
			if (ChainMode == "CFB"){
				return Crypt.Constants.BCRYPT_CHAIN_MODE_CBC
			}
			if (ChainMode == "ChainingModeCFB"){
				return Crypt.Constants.BCRYPT_CHAIN_MODE_CFB
			}
			if (ChainMode == "ECB"){
				return Crypt.Constants.BCRYPT_CHAIN_MODE_CBC
			}
			if (ChainMode == "ChainingModeECB"){
		...
		{
			if (Algorithm == "AES"){
				return Crypt.Constants.BCRYPT_AES_ALGORITHM
			}
			if (Algorithm == "DES"){
				return Crypt.Constants.BCRYPT_DES_ALGORITHM
			}
			if (Algorithm == "RC2"){
				return Crypt.Constants.BCRYPT_RC2_ALGORITHM
			}
			if (Algorithm == "RC4"){
				return Crypt.Constants.BCRYPT_RC4_ALGORITHM
			}
			return ""
			;switch Algorithm
			;{
		...
		{
			if (Algorithm == "MD2"){
				return Crypt.Constants.BCRYPT_MD2_ALGORITHM
			}
			if (Algorithm == "MD4"){
				return Crypt.Constants.BCRYPT_MD4_ALGORITHM
			}
			if (Algorithm == "MD5"){
				return Crypt.Constants.BCRYPT_MD5_ALGORITHM
			}
			if (Algorithm == "SHA1" or Algorithm == "SHA-1"){
				return Crypt.Constants.BCRYPT_SHA1_ALGORITHM
			}
			if (Algorithm == "SHA256" or Algorithm == "SHA-256"){
				return Crypt.Constants.BCRYPT_SHA256_ALGORITHM
			}
			if (Algorithm == "SHA384" or Algorithm == "SHA-384"){
				return Crypt.Constants.BCRYPT_SHA384_ALGORITHM
			}
			if (Algorithm == "SHA512" or Algorithm == "SHA-512"){
				return Crypt.Constants.BCRYPT_SHA512_ALGORITHM
			}
			return ""
			;switch Algorithm
			;{
